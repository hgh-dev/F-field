/* ==========================================================================
   [모듈] 사진 UI 모듈 (ui-photo.js)
   [역할]
   - 사진 선택 메뉴, 업로드 처리, 썸네일 영역, 사진 모달/다운로드 흐름을 담당합니다.
   - 레이어 상세 바텀시트에 들어가는 사진 관련 화면 조각 생성도 함께 관리합니다.
   [동작 원리 요약]
...
import { resizeImage } from './utils.js?v=2.5.0';
import { saveToStorage } from './data.js?v=2.5.0';
import { updateLayerInfo } from './ui-core.js?v=2.5.0';
